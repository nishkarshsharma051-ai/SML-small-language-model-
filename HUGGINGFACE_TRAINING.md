...
```bash
python3 hf_train.py --base-model Qwen/Qwen2.5-1.5B-Instruct --use-lora --output-dir hf_local_model
```
...
- The default training target is `Qwen/Qwen2.5-1.5B-Instruct`, which is instruction-tuned, multilingual, and designed for stronger coding/math/general chat behavior.
